...
# tree-sitter code-nav fallback tier only uses go/python/typescript/tsx/c/cpp/c_sharp/rust.
...
GRAMMAR_TAGS := grammar_subset grammar_subset_go grammar_subset_python grammar_subset_typescript grammar_subset_tsx grammar_subset_c grammar_subset_cpp grammar_subset_c_sharp grammar_subset_rust
