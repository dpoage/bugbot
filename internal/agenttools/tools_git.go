...
func NewGitBlame(dir string, runner gitRunner) (agent.Tool, error) {
...
func (t *gitBlameTool) Def() llmkit.ToolDef {
...
//
// runner may be nil to use the real git subprocess.
func NewGitLog(dir string, runner gitRunner) (agent.Tool, error) {
	if runner == nil {
		runner = realGitRunner
	}
...
func (t *gitLogTool) Def() llmkit.ToolDef {
	return llmkit.ToolDef{
		Name: "git_log",
		Description: fmt.Sprintf(
